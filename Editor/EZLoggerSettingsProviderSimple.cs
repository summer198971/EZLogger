...
{
    /// <summary>
    /// EZ Logger项目设置提供程序 - 简化版本
    /// 在Unity Project Settings中显示EZ Logger配置界面
    /// </summary>
    public class EZLoggerSettingsProviderSimple : SettingsProvider
    {
        private EZLoggerSettings settings;
        private SerializedObject serializedSettings;

        public EZLoggerSettingsProviderSimple(string path, SettingsScope scope = SettingsScope.Project)
            : base(path, scope) { }
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            DrawUnityConsoleSettings();
            EditorGUILayout.Space();
            
            DrawFileOutputSettings();
            EditorGUILayout.Space();
        ...
        {
            EditorGUILayout.LabelField("异步处理", EditorStyles.boldLabel);
        ...
        {
            EditorGUILayout.LabelField("Unity控制台", EditorStyles.boldLabel);
        ...
        {
            EditorGUILayout.LabelField("服务器上报", EditorStyles.boldLabel);
        ...
        {
            EditorGUILayout.LabelField("系统监控", EditorStyles.boldLabel);
        ...
        {
            var provider = new EZLoggerSettingsProviderSimple("Project/EZ Logger", SettingsScope.Project)
            {
